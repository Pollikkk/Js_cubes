...
var ex_sq = document.getElementById('example_sq2');
...
let timerId = setInterval(function() {
    ...
    if (startTime === null) {
        ...
        example.setAttribute('id', 'example_sq2');
        ...
        for (let i=0; i<kol; i++){ 
            ...
            square.setAttribute('id', 'example_sq2');
                ...
                ex_sq.addEventListener("drop", function(e){
                    ...
                    if(ex_sq.className === selected.className){
                        ...
                        setTimeout(() => {clearInterval(timerId);
                            ...
                            localStorage.setItem('lvl2', RightScores);
            ...
            children[i].addEventListener("click", event => {
                if(event.target.parentElement.className === ex_sq.className){   //right!
                    ...
                    setTimeout(() => {clearInterval(timerId);
                        ...
                        ex_sq.innerHTML = "<h1>Неправильно :(</h1>";
                        sq_s.innerHTML = "Ваши очки: " + RightScores;
                        localStorage.setItem('lvl2', RightScores);}, 3000);
...
function FillWithSq(field){    
    let name = '';
    for (let i=0; i<16; i++){    //заполнение квадрата
