...
var ex_sq = document.getElementById('example_sq');
...
let timerId = setInterval(function() {
    ...
    if (startTime === null) {
        ...
        example.setAttribute('id', 'example_sq');
        ...
        for (let i=0; i<kol; i++){ 
            ...
            square.setAttribute('id', 'example_sq');
                ...
                ex_sq.addEventListener("drop", function(e){
                    ...
                    if(ex_sq.className === selected.className){
                        ...
                        setTimeout(() => {clearInterval(timerId);
                            ...
                            localStorage.setItem('lvl1', RightScores);
            ...
            sq_s.addEventListener("click", event => {
                if(event.target.parentElement.className === ex_sq.className){   //right!
                    ...
                    setTimeout(() => {clearInterval(timerId);
                        ...
                        ex_sq.innerHTML = "<h1>Неправильно :(</h1>";
                        sq_s.innerHTML = "Ваши очки: " + RightScores;
                        localStorage.setItem('lvl1', RightScores);}, 3000);
...
function FillWithSq(field){    
    let name = '';
    for (let i=0; i<9; i++){    //заполнение квадрата
  ...
  /*function Decrease(field){
    field.style.height = field.style.height / 2;
    field.style.width = field.style.width / 2;
  }*/